...
def Closure_Str_RN_analysis(file_path):
       ...
       execution_time=end_time-start_time
       with open(output_file, 'ab') as file:
              new_data = {"Number of synergies": syn}
              pickle.dump(new_data, file)
...
#Encapsulating the whole analysis in one function
#Closure_Str_RN_analysis(file_path)
