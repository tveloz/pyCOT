...
from pyCOT.simulations_old import *
from pyCOT.visualization.plot_dynamics import plot_series_ode, plot_abstraction_size, plot_abstraction_sets, plot_abstraction_graph_movie_html
...
# ======================================== 
abstract_time_series = abstraction_ordinary(ts, threshold=0.05)
